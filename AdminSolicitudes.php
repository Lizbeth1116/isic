                        ...
                        foreach ($solicitud as $solicitudNV) {
                            if ($solicitudNV[10] == 2) {
                                ...
                                <tr>
                                    ...
                                    <td>' . $solicitudNV[7] . '</td>
                                    <td>' . $solicitudNV[8] . '</td>
                                    <td> <a href=# data-toggle="modal" data-target="#myModalSoliComNo" onclick="modVerMasSoli(\'' . $solicitudNV[1] . '\', \'' . $solicitudNV[2] . '\', \'' . $solicitudNV[3] . '\', \'' . $solicitudNV[4] . '\', \'' . $solicitudNV[5] . '\', \'' . $solicitudNV[6] . '\', \'' . $solicitudNV[7] . '\', \'' . $solicitudNV[8] . '\', \'' . $solicitudNV[9] . '\');">Ver mas</a>
